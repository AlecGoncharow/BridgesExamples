...
{
    public static String bohemianRhapsody = "[Intro]\n" +
    ...
    public static String feelGoodInc = "[Intro: Trugoy the Dove & 2D]\n" +
            ...
            "Is everybody in?\n" +
            "\n" +
            "[Outro: Trugoy the Dove & 2D]\n" +
            "Don't stop, get it, get it (Sha, sha ba da, sha ba da, Feel Good)\n" +
            "Peep how your captain's in it\n" +
            "Steady, watch me navigate, ha-ha-ha-ha-ha! (Sha, sha ba da, sha ba da, Feel Good)\n" +
            "Don't stop, get it, get it (Sha, sha ba da, sha ba da, Feel Good)\n" +
            "Peep how your captain's in it\n" +
            "Steady, watch me navigate, ha-ha-ha-ha-ha! (Sha, sha ba da, sha ba da, Feel Good)\n" +
            "Sha, sha ba da, sha ba da, feel good (Ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha!)\n" +
            "Sha, sha ba da, sha ba da, feel good (Ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha!)\n" +
            "Sha, sha ba da, sha ba da, feel good (Ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha-ha!)\n" +
            "Sha, sha ba da, sha ba da, feel good";

    public static String iFeelGood = "Wo! I feel good, I knew that I wouldn't of\n" +
